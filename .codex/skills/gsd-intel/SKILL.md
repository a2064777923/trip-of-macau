...
Intel system is disabled. To activate:
  ...
  node D:/Archive/trip-of-macau/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node D:/Archive/trip-of-macau/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node D:/Archive/trip-of-macau/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node D:/Archive/trip-of-macau/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: D:/Archive/trip-of-macau/.codex/get-shit-done/bin/gsd-tools.cjs

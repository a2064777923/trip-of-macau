...
<reference>
@D:/Archive/trip-of-macau/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Archive/trip-of-macau/.codex/get-shit-done/references/user-profiling.md` to load:

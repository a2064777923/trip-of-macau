...
public class BadgeController {
    ...
    @Operation(summary = "List published badges")
    @GetMapping
    public ApiResponse<List<BadgeResponse>> list(@RequestParam(required = false) String locale) {
        return ApiResponse.success(publicCatalogService.listBadges(locale));
    }
}

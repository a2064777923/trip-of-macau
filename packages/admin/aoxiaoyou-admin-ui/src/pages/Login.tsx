  ...
  return (
    <div
      style={{
        ...
        padding: 24,
        background:
          'radial-gradient(circle at top left, rgba(124, 92, 255, 0.18), transparent 28%), linear-gradient(135deg, #eef2ff 0%, #f6f8ff 50%, #eef5ff 100%)',
      }}
    >
      <Card
        style={{ width: 480, borderRadius: 26, boxShadow: '0 28px 80px rgba(60, 72, 140, 0.18)' }}
      ...
      >
        <Space direction="vertical" size={12} style={{ width: '100%', marginBottom: 28 }}>
          ...
          <Paragraph type="secondary" style={{ marginBottom: 0 }}>
            統一管理小程序內容、地圖空間、媒體資源、AI 能力與營運設定，作為 Trip of Macau 的唯一控制平面。
          </Paragraph>
        </Space>
        ...
        <Form name="login" onFinish={handleLogin} autoComplete="off" layout="vertical" size="large">
          ...
          >
            <Input prefix={<UserOutlined />} placeholder="請輸入後台帳號" autoComplete="username" />
          </Form.Item>
          ...
          >
            <Input.Password prefix={<LockOutlined />} placeholder="請輸入密碼" autoComplete="current-password" />
          </Form.Item>
